...
/**
 * Allow system apps to access hidden APIs:
 * ApplicationInfo.isPackageWhitelistedForHiddenApis constantly returns true
 * for system/updated system apps, even if they are not platform-signed.
 */
