...
/**
 * CPU frequency Hook module - fixes CPU clock readings in game services.
 * Function: Hooks CPU frequency retrieval methods in com.zui.game.service.util.HWDataInterface
 * to always read frequency data from the last CPU core.
 */
class CpuFrequencyFix : AppHookModule() {
    ...
    override fun handleLoadPackage(param: PackageLoadedParam) {
        ...
        try {
            ...
            // Hook HWDataInterface.getCpuCurFreq() method (no parameters)
            ...
            // Hook HWDataInterface.getCpuCurFreq(int coreIndex) method
            ...
            // Hook HWDataInterface.getCpuMaxFreq() method
    ...
    /**
     * Get current frequency of the last CPU core.
     */
    private fun getLastCpuCoreCurrentFreq(): Int {
        try {
            // Get index of the last CPU core
            ...
            // If reading fails, try fallback method
    ...
    /**
     * Get maximum frequency of the last CPU core.
     */
    ...
    private fun getLastCpuCoreIndex(): Int {
        try {
            ...
            // Sort by core number descending, pick the largest (last core)
    ...
    /**
     * Fallback method: Read current CPU frequency.
     */
    private fun readFallbackCpuFreq(): Int {
        try {
            // Try reading cpu0 current frequency
    ...
    /**
     * Fallback method: Read maximum CPU frequency.
     */
    private fun readFallbackCpuMaxFreq(): Int {
        try {
            // Try reading cpu0 max frequency
