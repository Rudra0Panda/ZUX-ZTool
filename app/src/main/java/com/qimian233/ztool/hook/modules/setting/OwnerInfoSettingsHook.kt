 ...
 * <p>
 * Split from [OwnerInfoHook]: handles only com.android.settings process,
 * registering screen state broadcast receiver upon Settings page / Activity resume.
...
class OwnerInfoSettingsHook : AppHookModule() {
    ...
    private fun hookSettingsPackage(classLoader: ClassLoader) {
        logger.info("Starting hook for Settings package")

        // Hook point 1: Register in SecuritySettings
        try {
