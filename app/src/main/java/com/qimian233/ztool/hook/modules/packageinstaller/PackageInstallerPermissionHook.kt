...
/**
 * Package installer permission management Hook module.
 * Forcibly sets permission management option to "Always Allow", simplifying user operations.
 */
...
class PackageInstallerPermissionHook : AppHookModule() {
    ...
    private fun hookPackageInstaller(classLoader: ClassLoader) {
        try {
            // Method 1: Hook startCustomInstallConfirm method
            hookStartCustomInstallConfirm(classLoader)

            // Method 2: Hook PermissionsAdapter constructor
            hookPermissionsAdapterConstructor(classLoader)

            // Method 3: Hook PermissionsAdapter getCount method
            hookPermissionsAdapterGetCount(classLoader)

            // Method 4: Hook ListView setAdapter method
