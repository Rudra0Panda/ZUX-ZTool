...
class MagiskModuleManager {
    ...
    fun removeModule(context: Context): String {
        ...
        // Delete system configuration residue (optional, depends on requirement)
    ...
    fun installModule(context: Context): String {
        ...
        // 3. Move to target directory using Root and set permissions
