 ...
 *
 * Each key is categorized by data type and exposed as a named constant for use by
...
object PreferenceKeys {
    ...
    // System Framework · Package Manager Service (installation restriction bypass feature group)
    ...
    // as well as Hook side iterative matching
    ...
    /**
     * Look up the corresponding typed key object by key name.
